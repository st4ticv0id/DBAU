...
def readJSONValue(MainDirPath: str, SettingsName: str, SettingsNameValue: str):
    try:
        ...
        print("")
        print(Back.RED + "ERROR: Some problems were occurred during reading a specific setting. Please report your problem on https://github.com/st4ticv0id/DBAU/issues" + defaultBackColor)
...
def updateJSONValue(MainDirPath: str, SettingsName: str, SettingsNameValue: str, NewValue):
    try:
        ...
        print("")
        print(Back.RED + "ERROR: Some problems were occurred during updating a specific setting. Please report your problem on https://github.com/st4ticv0id/DBAU/issues" + defaultBackColor)
        print(Back.RED + f"attaching the file '{mainPath}/logs/updateJsonError_{currentDate}.log' or its contents. Sorry for the inconvenience!" + defaultBackColor)